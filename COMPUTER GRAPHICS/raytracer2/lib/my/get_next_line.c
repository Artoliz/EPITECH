...
** Last update Wed May 24 16:24:03 2017 Bastien LECUSSAN
*/
...
char	*check_fd(int *fd_save, const int *fd, char *str)
{
  if (*fd_save != *fd && *fd_save != -1)
    {
      free(str);
      return (NULL);
    }
